...
export async function buildTranscript(
  ...
  return { scenario: scenario.name, persona: scenario.persona, autLabel, turns, recordingWav, oracleTranscript, terminationReason: cap.terminationReason, goalDriven: cap.goalDriven };
}
